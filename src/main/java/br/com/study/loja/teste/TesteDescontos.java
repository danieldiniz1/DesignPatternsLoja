...
import br.com.study.loja.desconto.DescontoParaOrcamentoMaiorCincoItens;
import br.com.study.loja.desconto.DescontoParaOrcamentoValorMaiorQuinhentos;
...
public class TesteDescontos {
    ...
    public static void main(String[] args) {
        Orcamento orcamento = new Orcamento(BigDecimal.valueOf(1000),1);
